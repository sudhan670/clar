class RoomsController < ApplicationController
  ...
  # FIX 1: Removed the broken @booking.room fallback — this controller
  # always looks up rooms by params[:id], not via a booking association.
  # FIX 2: Added `and return` so execution halts after the redirect when
